...
namespace CarsleySoft.Common
{
    public static class Requires
    {
        ...
        {
            if (String.IsNullOrWhiteSpace(argName)) { argName = "Invalid"; }
        ...
        ///// </summary>
        ///// <param name="value"><c>String</c> <paramref name="value"/> to check.</param>
        ///// <param name="parameterName"><c>String</c> <paramref name="parameterName"/> of the caller.</param>
        ///// <param name="message">Message for the exception</param>
        ///// <returns>Value to return if it is not null, empty or whitespace.</returns>
        ///// <exception cref="ArgumentException">
        /////     Thrown when <paramref name="value"/> is null or empty or whitespace.
        ///// </exception>
        //[DebuggerStepThrough]
        //public static string NotNullOrEmptyOrWhiteSpace(string value, string parameterName, string message = "String must not be null, empty or whitespace.")
        //{
        //    That<ArgumentException>(String.IsNullOrWhiteSpace(value), message);
        //    return value;
        //}
